...
export default function InstructorRescheduleRequestsPage() {
  ...
  const fetchInstructorRequests = async () => {
    ...
    try {
      const response = await getApiRequest(
        `/api/reschedule/instructor/${instructorId}`,
        token
      );
      ...
      if (response?.data?.success) {
        ...
        setError(
          response?.data?.message || "Failed to load instructor requests"
        );
      }
    } catch (err: any) {
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Instructor Reschedule Requests
              </h1>
              <p className="text-slate-600">
                View all reschedule requests for this instructor
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-6 mb-8">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-slate-600">{instructor.email}</p>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex flex-col sm:flex-row gap-4 flex-1">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search by session, student, or reason..."
                  value={searchTerm}
                        ...
                        <div>
                          ...
                          <p className="text-slate-500">
                            {searchTerm || statusFilter !== "all"
                              ...
                              : "This instructor has no reschedule requests"}
                          </p>
                        </div>
                      </div>
                    </td>
